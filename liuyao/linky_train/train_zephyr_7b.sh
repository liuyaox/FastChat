...
DATA_PATH=/dfs/comicai/yao.liu/repo/linky_rp_data/linky_rp_merge/data/pretrain/train_maxlen2048.json
EVAL_DATA_PATH=/dfs/comicai/yao.liu/repo/linky_rp_data/linky_rp_merge/data/pretrain/dev.json
OUTPUT_DIR=/dfs/comicai/yao.liu/checkpoints/linky_llm_v2/zephyr_7b_pretrian_v0.2
